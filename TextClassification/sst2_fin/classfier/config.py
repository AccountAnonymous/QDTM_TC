...
flags.DEFINE_string("filter_sizes", '5,10,40', "Comma-separated filter sizes (default: '3,4,5')")
#flags.DEFINE_integer("num_filters", 60, "Number of filters per filter size (default: 128)") #  0.784
flags.DEFINE_integer("num_filters", 100, "Number of filters per filter size (default: 128)") #  0.784
...
# Training parameters
flags.DEFINE_integer("batch_size", 140, "Batch Size (default: 64)")  #  0.784
#flags.DEFINE_integer("batch_size", 150, "Batch Size (default: 64)")  #  0.782
#flags.DEFINE_integer("batch_size", 128, "Batch Size (default: 64)")  #  0.772
#flags.DEFINE_integer("batch_size", 130, "Batch Size (default: 64)")   #  0.771
#flags.DEFINE_integer("batch_size", 160, "Batch Size (default: 64)")  #  0.771
...
#flags.DEFINE_string('data','cr','data set')
flags.DEFINE_string('data','sst2','data set')
